...
func handleConnection(conn net.Conn, modulus []byte, key *rsa.PrivateKey) {
	// Only for client version that use RSA to encrypt the requestAuthLogin packet
...
func Init() {
	...
	test := []byte{0x32, 0x00, 0xa2, 0x2d, 0x82, 0x61, 0xcb, 0xb7, 0x9a, 0x9c, 0xdb, 0xe8, 0xb5, 0xce, 0xca, 0x47,
		0xed, 0x52, 0x6c, 0x46, 0x2b, 0x2a, 0x09, 0x75, 0x8e, 0x82, 0x0d, 0x2d, 0x41, 0x44, 0x78, 0x22,
		0x29, 0xb6, 0x76, 0x62, 0x4a, 0x79, 0xfe, 0x01, 0xed, 0x06, 0xdf, 0x3f, 0x21, 0xaa, 0x87, 0x1b,
		0x98, 0xa9}

  _, _ = packet.Decrypt(test)
